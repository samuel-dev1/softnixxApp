           ...
           <ActivityIndicator />
            ...
            <FlatList
               ...
               renderItem={({ item }) => (
                  <SafeAreaView>
                     {item && loading == false ?
                        <ListItem onPress={()=>navigation.navigate('stasckrecipt',{"id":item.request_id})} containerStyle={{
                           backgroundColor: "#fff",
                           padding: 10,
                           margin: 5,
                        }} bottomDivider>
                           <Icon color={"darkblue"} size={40} name="money" type="font-awesome" />
                           <ListItem.Content>
                              <Text style={{
                                 color: "#333",
                                 fontSize: 17,
                           ...
                           <View>
                              ...
                              <Text><Badge status='warning' value={"check status"} /></Text>
                           </View>
                           <ListItem.Chevron />
                        </ListItem>
                        : null}
