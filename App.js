  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{
        ...
        <Stack.Screen name='reciept' component={ReceiptTab}
          options={{
            headerShown: true
          }}
        />
        ...
        />
        <Stack.Screen name='receptutils' component={ReceiptUtilites}
          options={{
            headerShown: true
          }}
        />
        <Stack.Screen name='stacksoft' component={ReceiptSoft}
          options={{
            headerShown: true
          }}
        />
        <Stack.Screen name="stasckrecipt" component={ReceiptDetails}
          options={{
            headerShown: true
          }}
        />
        ...
        />
        <Stack.Screen name='allpage' component={AllServicePage}
          options={{
            headerShown: true
          }}
        />
        <Stack.Screen name='tvs' component={Tv}
          options={{
            headerShown: true
          }}
        />
        ...
        />
        <Stack.Screen name='pin' component={SetPinPage}
          options={{
            headerShown: true
          }}
        />
        <Stack.Screen name='check' component={Checkterm} />
        <Stack.Screen name='password change' component={ChangePass}
          options={{
            headerShown: true
          }}
        />
        <Stack.Screen name='register' component={SignInPage}
          options={{
            headerShown: false
          }}
        />
        ...
        />
        <Stack.Screen name='benefit' component={BenefitOverlay}
          options={{
            headerShown: true
          }}
        />
